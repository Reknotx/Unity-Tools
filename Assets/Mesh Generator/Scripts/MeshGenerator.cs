...
{
    /// <summary>
    /// Generates the mesh data for the terrain based on the height map.
    /// </summary>
    /// <param name="heightMap"></param>
    /// <param name="heightMultiplier"></param>
    /// <param name="heightCurve"></param>
    /// <param name="lod"></param>
    /// <param name="useFlatShading"></param>
    /// <returns></returns>
...
public class MeshData
{
    ...
    {
        if (vertexIndex < 0) borderVertices[-vertexIndex - 1] = vertexPosition;
        else
        {
